-- Recommended data.sql seed file
...
VALUES
    (1, 'John Doe', 'john@example.com', '$2a$10$r71PF/uSjFaXGgFN3WK67OGATjEFCWMH6vGpuzxfZfmVcJA5bdyfu', '0911444444', 'ETH123456', 0.00, 'Churchill Avenue', 'Addis Ababa', '1000'),
    (2, 'Jane Smith', 'jane@example.com', '$2a$10$r71PF/uSjFaXGgFN3WK67OGATjEFCWMH6vGpuzxfZfmVcJA5bdyfu', '0911555555', 'ETH654321', 150.00, 'Bole Road', 'Addis Ababa', '2000'),
    (3, 'Michael Brown', 'michael@example.com', '$2a$10$r71PF/uSjFaXGgFN3WK67OGATjEFCWMH6vGpuzxfZfmVcJA5bdyfu', '0911666666', 'ETH789012', 0.00, 'Kazanchis', 'Addis Ababa', '3000')
ON CONFLICT (customer_id) DO NOTHING;

INSERT INTO car
(car_id, plate_number, brand, model, year, mileage, availability, daily_rate, car_type, branch_id)
VALUES
...
INSERT INTO car_reservation (car_id, reservation_id) VALUES
                                                         (1, 1),
                                                         (2, 2),
                                                         (4, 3)
...
INSERT INTO rental
(rental_id, checkout_date, return_date, start_mileage, end_mileage, status, base_charge, customer_id, car_id)
VALUES
...
INSERT INTO payment
(payment_id, payment_date, amount, payment_method, stripe_payment_intent_id, status, rental_id)
VALUES
    (1, '2026-06-10', 350.00, 'CREDIT_CARD', 'pi_test_123456', 'COMPLETED', 1),
    (2, '2026-06-12', 450.00, 'CASH', NULL, 'COMPLETED', 2)
ON CONFLICT (payment_id) DO NOTHING;

INSERT INTO damage
(damage_id, report_date, repair_cost, status, description, rental_id)
VALUES
    (1, '2026-06-18', 0.00, 'CLOSED', 'Vehicle returned without damage', 1),
    (2, '2026-06-20', 500.00, 'OPEN', 'Front bumper scratched', 2)
ON CONFLICT (damage_id) DO NOTHING;
